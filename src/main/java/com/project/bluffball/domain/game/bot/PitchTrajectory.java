 ...
 *
 * <p>{@link com.project.bluffball.domain.card.entity.PitchCard#calculateFinalCoordinateNumber}
 * 와 동일한 격자 규칙을 쓴다. 봇 정책·테스트에서 Reader/Entity 없이 판단할 때 사용한다.</p>
 */
public final class PitchTrajectory {
     ...
     */
    public static int finalCoordinate(int startCoordinateNumber, CardInfo pitch) {
     ...
     * @return 최종 좌표 또는 0
     */
    public static int finalCoordinate(
     ...
     *
     * <p>{@link com.project.bluffball.domain.game.service.usecase.reader.CoordinateCardReader#isStrikeZone}
     * 과 동일 좌표 집합이다.</p>
     *
     * @param coordinateNumber 좌표
     * @return 존이면 true
     */
    public static boolean isStrikeZone(int coordinateNumber) {
